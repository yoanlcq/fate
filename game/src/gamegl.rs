...
void main() {
    v_position = u_model_matrix * vec4(a_position.xyz, 1.0);
    v_normal = u_normal_matrix * vec4(a_normal.xyz, 1.0);
    v_color = a_color;
    gl_Position = u_viewproj_matrix * v_position;
}
";
